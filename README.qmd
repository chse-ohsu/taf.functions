...
Thus, to execute an R script, you can use 'shell Rscript', or 'shell "C:\\R\\R-4.2.1\\bin\\R.exe" Rscript. Say you saved your R script to my_r\_script.R - the following Stata code should execute your R script from Stata:
